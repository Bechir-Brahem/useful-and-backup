...
theme.wallpaper                                 = "/home/bb/Documents/Light-umbrella-dark-wallpaper-1920x1080.jpeg"
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow(theme.bg_normal, "#b04a98"),
          wibox.container.background(wibox.container.margin(wibox.widget { volume_widget{
          }, layout = wibox.layout.align.horizontal }, 2, 3), "#b04a98"),
            arrow("#b04a98", "#777E76"),
            ...
            arrow("#C0C0A2", "#000000"),
            wibox.container.background(wibox.container.margin(mytextclock, 4, 8), "#000000"),
            arrow("#000000", "alpha"),
        logout_menu_widget{
            font = 'Play 14',
        },
