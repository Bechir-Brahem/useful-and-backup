...
function cp_tmp_func() {
    ...
    cp $home/Templates/.clang-format .clang-format
    cp $home/Templates/main.cpp $1.cpp
    nvim +21 test.cpp
    $SHELL
}
function cop() {
...
function cf() {
    if [ -d $home/cp/cf/$1-c++14 ]; then
        echo "this problem directory exists"
        cd $home/cp/cf/$1-c++14
    else
        python3 $home/github/useful-and-backup/useful/parse.py $1
        cd $home/cp/cf/$1-c++14
    fi
}
function pidoff() {
...
# alias ....="cd ../.."
alias gdb="gdb -q"
alias upcoming_contest="$home/github/useful-and-backup/useful/upcoming_contest.py"
alias doc="$home/github/useful-and-backup/useful/doc_viewer.py"
alias courses="$home/github/useful-and-backup/useful/courses_viewer.py"

alias py3="python3"
# alias cf="py3 $home/github/useful-and-backup/useful/parse.py"
alias thingy="cp ~/Templates/main.cpp ."
alias do="./do"
alias amir="echo \"20898795\""
alias clinic="echo \"36089000\""
alias ambulance="echo \"92147267\""
alias algo="v $home/github/useful-and-backup/course-notes/algo/notes.md"
alias comj='find . -name "*.java" -type f | xargs javac '
java8="/usr/lib/jvm/java-8-openjdk-amd64/bin/"
# export PATH="$PATH:/home/bb/.config/composer/vendor/bin"
export PATH=$PATH:/opt/gradle/gradle-7.0/bin
export java8

alias gitter="git add .; git commit -m 'a'; git push origin master"
export EDITOR="v"

alias ls="/home/bb/.local/share/gem/ruby/3.0.0/gems/colorls-1.4.4/exe/colorls"
alias lc="/bin/ls"
